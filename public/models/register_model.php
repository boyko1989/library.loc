...
function create_new_user($login, $password,$vis_name) {
    ...
    $create_first_users_theme = "INSERT INTO `theme`(`id`, `title`, `parent`, `author`) VALUES (NULL,'Главная',0, $user_id);";
    $res_create_first_users_theme = mysqli_query($connection, $create_first_users_theme);
